...
if (true) then
{
  _this = _group_0 createUnit ["Bandit1_DZ", [14246.129, 2849.6973, 0], [], 0, "CAN_COLLIDE"];
  _unit_7 = _this;
...
_this = createMarker ["DZAI_Sissach", ];
_this setMarkerShape "ELLIPSE";
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
_this setMarkerSize [175, 175];
...
_this = createMarker ["DZAI_centerMarker", [10725.096, 9339.918, 0]];
_this setMarkerShape "ELLIPSE";
_this setMarkerType "Flag";
_this setMarkerBrush "Solid";
